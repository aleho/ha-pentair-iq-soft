...
if [[ $1 == "stats" ]]; then
    curl -i \
        ...
        -d '{"id":"'$DEV_ID'","content":{"ts":'$TS',"payload":{"total_flow":'$TOTAL_FLOW',"capacity_remaining":'$CAPACITY',"state":1,"cycle_timer":0,"brine_fill_seconds":518,"days_maintenance":32,"salt_alarm_count":'$SALT',"maintenance_time":24,"firmware_msg":"FW_STRING","pn_msg":"PING_STRING","minute":'$MINUTE'}},"t":"SOMETHING"}'
